      ...
      <div className="px-4 pt-6 pb-6">
        ...
        <Card>
          <div className="max-w-2xl">
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      ...
                      <div className="text-lg font-semibold text-gray-900 dark:text-white">
                        {deliveryPincodeData.postal_code.district}
                      </div>
                    </div>
                    <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg">
                      <div className="flex items-center gap-3">
                        <div className={`h-3 w-3 rounded-full ${deliveryPincodeData.postal_code.repl === "Y" ? "bg-green-500" : "bg-red-500"}`}></div>
                        <span className="font-medium text-gray-900 dark:text-white">Return Service</span>
                      </div>
                      <span className={`text-sm font-semibold ${deliveryPincodeData.postal_code.repl === "Y" ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}>
                        {deliveryPincodeData.postal_code.repl === "Y" ? "Available" : "Not Available"}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            {/* Empty State */}
            {!deliveryPincodeData && !deliveryLoading && !deliveryError && (
