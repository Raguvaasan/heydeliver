...
const FranchiseStaffPage: FC = function () {
  ...
  const handleView = (staff: any) => {
    navigate(`/franchise-staff/${staff._id}`)
  }
                  ...
                  {filteredStaffs.length > 0 ? (
                    filteredStaffs.map((staff, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <Badge color={(staff.status === "Active" || staff.status === true) as any ? "success" : "failure"}>
                            {(staff.status === "Active" || staff.status === true) as any ? "Active" : "Inactive"}
                          </Badge>
                        </td>
                        <td className="px-4 py-3">
      ...
      <NavbarSidebarLayout isFooter={false}>
        <div className="px-4 pt-6">
          <div className="text-center py-12">
            <p className="text-red-600 font-bold">Error loading staff page</p>
...
const EditStaffModal: FC<{
  ...
  userData: any
  roles: any[]
}> = ({ isOpen, onClose, onSubmit, userData, roles }) => {
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    phone: "",
