...
const EditCustomerModal: FC<EditCustomerModalProps> = ({ isOpen, onClose }) => {
  const { selectedCustomer, updateCustomer, loading } = useCustomerStore()
  ...
  const handleSubmit = async (values: any) => {
    ...
    try {
      ...
      await updateCustomer(selectedCustomer.id, sanitizedValues)
      onClose()
    } catch {
